...
with st.form("formulario"):
    # —> usa key em vez de value, para que o campo grude em st.session_state["codigo"]
    ...
    # busca produto sempre lendo de st.session_state["codigo"]
    if buscar:
    ...
    # campos manuais, que já puxam de session_state
    ...
    if adicionar and st.session_state["codigo"]:
        ...
        # limpa apenas os campos do produto (não apaga o crédito, etc)
        for campo in ["codigo","nome","marca","fabricante","categoria"]:
            st.session_state[campo] = ""
        st.rerun()
